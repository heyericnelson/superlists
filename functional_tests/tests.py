...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        # User heard about a new online to-do app. She goes to the homepage.
        self.browser.get(self.live_server_url)
        ...
        # She wonders whether the site will remember her list. Then she sees that the
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        # Now a new User B comes to the site

        ## We use a new browser session to make sure that no information
        ## of User A is coming through from cookies, etc.
        self.browser.quit()
        self.browser = webdriver.Firefox()
        ...
        # User B starts a new list by entering a new item. He is less interesting than User A
        inputbox = self.browser.find_element_by_id('id_new_item')
        inputbox.send_keys('Buy milk')
        inputbox.send_keys(Keys.ENTER)
        self.wait_for_row_in_list_table('1: Buy milk')

        # User B gets his own unique URL
        ...
        # Again, there is no trace of user A's list
        page_text = self.browser.find_element_by_tag_name('body').text
        self.assertNotIn('Buy peacock feathers', page_text)
